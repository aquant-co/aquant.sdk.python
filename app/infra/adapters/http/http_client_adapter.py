...
from app.core.exceptions.http.http_exception import HTTPException
from app.core.exceptions.http.http_exception_handler_interface import (
    HTTPExceptionHandlerInterface,
)
from app.core.logger.logger_interface import LoggerInterface
from app.infra.adapters.http.http_interface import HTTPClientInterface

from .types import RequestDataType


class HTTPAdapter(HTTPClientInterface):
    """
    ...
    def __init__(
        ...
        exception_handler: HTTPExceptionHandlerInterface | None = None,
    ):
        """
    ...
    async def request(
        ...
        try:
            ...
            # # Decide como processar o conteúdo
            ...
            #     data = response.text
            #     self.logger.info(f"Plain Text Response: {data}")
            #     return {"data": data}
            # else:
            #     data = response.content
            #     self.logger.warning("Unknown Content-Type. Returning raw bytes.")
            #     return {"data": data}
